...
public final class CameraManager {
	...
	public void setFramingRect(double density) {
		MIN_FRAME_WIDTH = (int) (400.00 / 3.00 * density);
		MIN_FRAME_HEIGHT = (int) (400.00 / 3.00 * density);
		MAX_FRAME_WIDTH = (int) (650.00 / 3.00 * density);
		MAX_FRAME_HEIGHT = (int) (650.00 / 3.00 * density);
	}
}
