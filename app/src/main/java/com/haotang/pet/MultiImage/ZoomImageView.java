...
public class ZoomImageView extends ImageView {
    ...
    public void setSourceImageBitmap(Bitmap bitmap, Activity activity) {
        sourceBitmap = bitmap;
        int screenWidth = ((WindowManager) (MApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
        int screenHeight = ((WindowManager) (MApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
