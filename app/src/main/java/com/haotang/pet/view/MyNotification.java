...
public class MyNotification {
    ...
    public void showCustomizeNotification(int icoId,String titleStr,int layoutId) {  
        ...
        notification=new Notification(R.drawable.logo, titleStr, when);
        ...
        if(remoteView==null)
        {
            ...
            remoteView.setTextViewText(R.id.tvTip, "下载未启动"); 
     ...
     * @param p 进度值(0~100)
     */
    public void changeProgressStatus(double p)
    {
        if(notification.contentView!=null)
        {
            ...
            notification.contentView.setProgressBar(R.id.pbNotification, 100, (int)p, false);
        }
        nm.notify(notificationID, notification);
    }
