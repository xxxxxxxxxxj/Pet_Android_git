 ...
 */
@SuppressLint("NewApi")
public class TopIndicator_B extends LinearLayout {
	...
	public TopIndicator_B(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public TopIndicator_B(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TopIndicator_B(Context context) {
		super(context);
		init(context);
	}
